...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        player.pause(true);
        let embed = new MessageEmbed().setAuthor(`Paused!`, "https://img.icons8.com/color/2x/cd--v3.gif").setColor("RANDOM").setDescription(`Type \`${GuildDB.prefix}resume\` to continue playing!`);
